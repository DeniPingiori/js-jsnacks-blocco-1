...
snack2
1. - crea array vuoto
2. - esegui ciclo di 6 iterazioni
3. - all'interno un prompt in cui user inserisce un num
4. - ? se il num inserito è dispari, metterlo nell'array
5. - : altrimenti non fare nulla
6. - mostrare array, con promp 